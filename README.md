...
| [`sch3step-edm.scm`](./sch3step-edm.scm) | Derived compact global CH4/CO/H2 subset in the Scharler six-step context; Base source: [Scharler et al. (2021)](https://doi.org/10.1016/j.enconman.2021.114755). | Compact three-step global gas-phase mechanism for methane, carbon monoxide and hydrogen oxidation with finite-rate / eddy-dissipation variants. Use this when only a minimal global gas-phase oxidation scheme is required. |
